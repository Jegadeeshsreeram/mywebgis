...
map.getView().fit([8525320.909748, 1089175.195839, 8681999.112441, 1176923.897845], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DEVIKULAM ADMINISTRATIVE BOUNDARY</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (96 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Devikulam is a hillstation located at idukki district was one of the beautiful places in kerala.';
            }
